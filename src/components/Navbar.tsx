...
const Navbar = () => {
    ...
    return (
        // <nav className="bg-blue-500 p-4 flex items-center justify-between w-full fixed ">
            ...
            <nav className="flex dark:bg-slate-900 items-center relative justify-between bg-gradient-to-r from-teal-400 to-yellow-200 px-5 py-6 w-full ">
                ...
                <div className="flex gap-3 items-center">
                    <Link href='/cart' className='relative'>
                        ...
                        <span className="absolute -top-4 left-4 rounded-full bg-red-500 p-0.5 px-2 text-sm text-red-50">4</span>
                    </Link>
